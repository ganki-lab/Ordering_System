...
1. **設定タブ**をタップ
2. **「データベース設定」**セクションの**「Supabase接続」**をタップ
3. Supabaseプロジェクトの情報を入力：
   - **Project URL**: `https://your-project.supabase.co`
   - **Anon Key**: Supabaseプロジェクトの匿名キー
4. **「保存」**をタップ
5. データ移行の確認が表示されたら**「移行する」**を選択（推奨）
